...
"Служба программной поддержки","Служба технической поддержки",
"Отдел тестирования продукции","Отдел технических требований",
"Отдел экспертного заключения",
"Конструкторский сектор","Отдел дизайна",
"Сектор разработки ПО","Студия анимации","Студия звукозаписи",
"Технологический сектор","Бухгалтерия",
"Отдел контрольно-ревизионной работы","IT-департамент","Отдел системных решений",
"Отдел информационно-управляющих",
"Студия аудио-видеопроизводства","Отдел тестирования ПО","Отдел управления",
"Отдел кадров","Отдел маркетинга","Отдел продаж"
]
ROOT_DEPARTMENTS = [
'Администрация', "Юридический отдел","ИТ-отдел",
"Отдел качества","Отдел материально-технического обеспечения","Отдел службы безопасности",
"Производственный отдел","Финансовый отдел","Отдел службы безопасности"
]
